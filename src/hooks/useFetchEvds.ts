...
export const useFetchEvdsMoney = () => {
  ...
  // fetch('https://evds2.tcmb.gov.tr/service/evds/series=TP.DK.USD.A.YTL-TP.DK.EUR.A-TP.DK.GBP.A&startDate=07-12-2022&endDate=07-12-2022&frequency=2&key=pzl0bde5dl&type=json', {
  //   mode: 'no-cors'
  // })
  //   .then(response => response.json())
  //   .then(data => console.log(data));
  // const testURL = 'https://evds2.tcmb.gov.tr/service/evds/series=TP.DK.USD.A.YTL-TP.DK.EUR.A-TP.DK.GBP.A&startDate=07-12-2022&endDate=07-12-2022&frequency=2&key=pzl0bde5dl&type=json';
	// const myInit = {
	// 	method: 'HEAD',
	// 	mode: 'no-cors',
	// };
  ...
  //       (async () => {
  //         try {
  //           const response = await axios.get('https://evds2.tcmb.gov.tr/service/evds/series=TP.DK.USD.A.YTL-TP.DK.EUR.A-TP.DK.GBP.A&startDate=07-12-2022&endDate=07-12-2022&frequency=2&key=pzl0bde5dl&type=json',request);
...
export const useFetchEvdsGold = () => {
  ...
  //     (async () => {
  //       try {
  //         const response = await axios.get(`https://api.allorigins.win/raw?url=${endPoint}`);
